    ...
    <div className="font-montserrat p-4 bg-white md:p-8 lg:p-10 dark:bg-gray-800">
        <div className="mx-auto max-w-screen-xl text-center">
            <div href="#" className="flex justify-center items-center text-2xl font-semibold text-gray-900 dark:text-white">
                <img className="mr-2 h-16" src={logo} />    
            </div>
            ...
            <ul className="flex flex-wrap justify-center items-center mb-6 text-gray-900 dark:text-white">
                ...
                <li>
                    <div href="#" className="mr-4 hover:underline md:mr-6 ">Campaigns</div>
                </li>
                <li>
                    <div href="#" className="mr-4 hover:underline md:mr-6">Blog</div>
                </li>
                <li>
                    <div href="#" className="mr-4 hover:underline md:mr-6">Affiliate Program</div>
                </li>
                <li>
                    <div href="#" className="mr-4 hover:underline md:mr-6">FAQs</div>
                </li>
                <li>
                    <div href="#" className="mr-4 hover:underline md:mr-6">Contact</div>
                </li>
            </ul>
            <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023-2024 <a href="#" class="hover:underline">The Dev Hub™</a>. All Rights Reserved.</span>
        </div>
    </div>
  )
}
