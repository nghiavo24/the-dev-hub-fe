    ...
    return (
        <div>
            ...
            <div className="flex justify-center ">
                <div className="w-6/8 px-20 mx-2 py-8 flex flex-col  sm:w-10/12 md:w-8/12 lg:w-5/12 xl:w-5/12 2xl:w-5/12     shadow-lg shadow-air-blue  border-gray-300 border rounded-lg mt-10">
                    ...
                    <div class=" flex justify-center  ">
                        <button className="font-lobster rounded-lg text-lg tracking-wider px-10 py-2  bg-dark-salmon text-white outline-none " onClick={deletePost}>Delete</button>
                    </div>
                </div>
            </div>
            <div className="flex justify-center  ">
                <form className="mx-2 mt-10 px-20 flex flex-col w-6/8 sm:w-10/12  md:w-8/12 lg:w-5/12 xl:w-5/12 2xl:w-5/12  shadow-lg shadow-air-blue rounded-lg border-gray-300 border " updatingPost={updatingPost}>
                    ...
                    <div class="flex justify-center"> 
                        <button className="font-lobster rounded-lg text-lg px-10 py-2 my-3 mb-5 tracking-wider bg-yellow-crayola text-white outline-none" onClick={updatingPost}>Update</button>
                    </div>
                </form>
            </div>
        </div>
