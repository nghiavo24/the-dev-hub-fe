  ...
  return ( 
    <nav className="font-lora bg-white border-gray-200 px-2 sm:px-4 py-2.5 rounded dark:bg-gray-900">
      <div className="container flex flex-wrap items-center justify-between mx-auto">
        <div className="">
            <Link to='/'><img src={logo} className="h-20 place-items-center" alt="The Dev Hub Logo" /></Link>
            {/* <span className="self-center text-lg font-semibold whitespace-nowrap dark:text-white"><Link to='/'>The Dev Hub</Link></span> */}
        </div>
        ...
        <div className="hidden w-full md:block md:w-auto" id="navbar-default">
          <ul className="flex flex-col p-4 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:text-lg md:font-medium md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
            ...
            {authorizedUser ? (
              <>
              <li>
                <div className="block py-2 pl-3 pr-4 text-air-blue rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-gray-400 md:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent">
                  {displayName}
                </div>
              </li>
              <li>
                <div 
                  onClick={logOutUser}
                  className="block py-2 pl-3 pr-4 text-dark-salmon rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-gray-400 md:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent">
                      Sign Out
                </div>
              </li>
              </>
