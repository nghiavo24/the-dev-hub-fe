...
const appList = allApplications.map((app, index) => {
    return(
        <div key={index} className="p-6 border mx-auto my-5 border-blonde bg-white shadow-lg rounded-lg box-border h-30 w-60">
  ...
  return (
    <div>
        <h1 className='text-4xl text-center mx-44'>MyHub</h1>
           ...
           <div className="container grid grid-cols-2 gap-4 mx-auto">{appList}</div>
