...
const appList = allApplications.map((app, index) => {
    return(
        <div key={index} className="container gap-4 p-5 border text-center my-5 border-blonde bg-white shadow-lg rounded-lg">
            <div class="p-5">
  ...
  return (
    <div>
        <h1 className='text-4xl text-center mx-44'>MyHub</h1>
           ...
           <div className="container grid grid-cols-1 gap-4 mx-auto py-9 md:grid-cols-2 lg:grid-cols-4">{appList}</div>
